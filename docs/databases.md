...
| ViPhOG metadata    | metadata for filtering ViPhOGs according to taxonomy updates by the [ICTV](https://ictv.global/taxonomy) | `--additional_model_data` | 2021    | ftp://ftp.ebi.ac.uk/pub/databases/metagenomics/viral-pipeline/additional*data_vpHMMs*{VERSION}.tsv                  | -                                                  |
| ViPhOG factor file | requred for taxonomy assignment                                                                          | `--factor_file`           | 2021    | https://github.com/EBI-Metagenomics/emg-viral-pipeline/blob/master/references/viphogs_cds_per_taxon_cummulative.csv | -                                                  |

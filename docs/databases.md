...
| ViPhOGs            | used for taxonomy assignment                                                                             | `--viphog_db`             | ftp://ftp.ebi.ac.uk/pub/databases/metagenomics/viral-pipeline/hmmer*databases/vpHMM_database*{VERSION}.tar.gz       | https://www.mdpi.com/1999-4915/13/6/1164           |
| ViPhOG metadata    | metadata for filtering ViPhOGs according to taxonomy updates by the [ICTV](https://ictv.global/taxonomy) | `--additional_model_data` | ftp://ftp.ebi.ac.uk/pub/databases/metagenomics/viral-pipeline/additional*data_vpHMMs*{VERSION}.tsv                  | -                                                  |
